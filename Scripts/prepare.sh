...
echo "LOCK_ENABLED=$(gsettings get org.gnome.desktop.screensaver lock-enabled)" > "$BACKUP_FILE"
echo "IDLE_DELAY=$(gsettings get org.gnome.desktop.session idle-delay)" >> "$BACKUP_FILE"
